// mactronome/App/MactronomeApp.swift
import SwiftUI
import AppKit
import Sparkle

@main
struct MactronomeApp: App {
    @NSApplicationDelegateAdaptor(MactronomeAppDelegate.self)
...
final class MactronomeAppDelegate: NSObject, NSApplicationDelegate {
    ...
    private func showMainWindow() {
        // SwiftUI가 Scene의 NSWindow를 만든 다음 실행되도록 다음 메인 루프로 넘깁니다.
        DispatchQueue.main.async {
            let mainWindow = NSApplication.shared.windows.first(where: { $0.canBecomeMain })
